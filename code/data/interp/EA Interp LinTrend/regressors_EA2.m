...
X(1).third=[ones(size(Xreg,1),1), Xreg(:,3)];
...
X(1).four=[ones(size(Xreg,1),1), Xreg(:,4), Xreg(:,5)]; 
...
X(1).five=[ones(size(Xreg,1),1), Xreg(:,6), Xreg(:,7)];
X(2).five=[ones(size(Xreg,1),1), Xreg(:,6), Xreg(:,7), Xreg(:,8)];
...
X(1).six=[ones(size(Xreg,1),1), Xreg(:,9), X_tr(:,10)];
